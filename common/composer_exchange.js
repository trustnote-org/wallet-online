...
var objectLength = require("trustnote-common/object_length.js");
...
var parentComposer = require('trustnote-common/parent_composer.js');
var paid_witnessing = require("trustnote-common/paid_witnessing.js");
var headers_commission = require("trustnote-common/headers_commission.js");
var mc_outputs = require("trustnote-common/mc_outputs.js");
var validation = require('trustnote-common/validation.js');
var writer = require('trustnote-common/writer.js');
var conf = require('trustnote-common/conf.js');
var profiler = require('trustnote-common/profiler.js');
...
function composePaymentJointExchange(arrFromAddresses, arrOutputs, signer, callbacks){
	composeJointExchange({paying_addresses: arrFromAddresses, outputs: arrOutputs, signer: signer, callbacks: callbacks});
}
...
function composeJointExchange(params){
	...
	if (params.minimal && !params.send_all){
		...
		var trySubset = function(count){
			...
			composeJointExchange(try_params);
		};
		...
		conn.query(err ? "ROLLBACK" : "COMMIT", function(){
			...
			async.each(
				...
				function(err){
					...
					//profiler.stop('compose');
					callbacks.ifOk(objUnit, assocPrivatePayloads, unlock_callback);
				}
			);
		});
	});
...
function composeJointExchangeToChain(objUnit, callbacks){
	var unlock_callback;
	var arrFromAddresses = [objUnit.authors[0].address];
	async.series([
		function(cb){ // lock
			mutex.lock(arrFromAddresses.map(function(from_address){ return 'c-'+from_address; }), function(unlock){
				unlock_callback = unlock;
			...
			console.log(typeof objJoint.unit);
...
function composeMinimalJoint(params){
	...
	readSortedFundedAddresses(null, params.available_paying_addresses, estimated_amount, function(arrFundedPayingAddresses){
		...
		composeJointExchange(minimal_params);
	});
}
...
exports.composePaymentJointExchange = composePaymentJointExchange;
...
exports.composeJointExchange = composeJointExchange;
exports.composeJointExchangeToChain = composeJointExchangeToChain;
