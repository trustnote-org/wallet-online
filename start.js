			...
			if (err){ // first start
				...
				writeKeys(deviceTempPrivKey, devicePrevTempPrivKey, function(){
					createWallet(strXPubKey, devicePrivKey, function(){
						onDone(strXPubKey, devicePrivKey, deviceTempPrivKey, devicePrevTempPrivKey);
					});
				});
...
exports.issueChangeAddressAndSendPaymentExchange = issueChangeAddressAndSendPaymentExchange;
